            ...
            <div class="widget-content-outer">
                <div class="widget-content-wrapper">
                    <div class="widget-content-left">
                        ...
                        <div class="widget-subheading">orders by value in US Dollars</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-success">${{number_format($counters[0], 2)}}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="widget-content-outer">
                <div class="widget-content-wrapper">
                    <div class="widget-content-left">
                        ...
                        <div class="widget-subheading">Orders received in the last 1/4</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-warning">{{number_format($counters[1], 0)}}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card mb-3 widget-content">
            <div class="widget-content-outer">
                <div class="widget-content-wrapper">
                    <div class="widget-content-left">
                        <div class="widget-heading">Average order($)</div>
                        <div class="widget-subheading">Order value averaged in past 1/4</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-danger">${{number_format($counters[2], 2)}}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">Recent orders
                ...
                <br>
                <a href="{{route('a_orders')}}" class="btn btn-lg btn-primary">More orders</a>
                </div>
                </div>
                <!-- end recents -->
            </div>
