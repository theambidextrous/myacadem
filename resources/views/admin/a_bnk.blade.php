...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div><a href="{{route('a_home')}}">Administrator Dashboard</a> > <a href="{{route('a_bnks')}}">Banks</a> > Single item</div>
        </div>
    </div>
</div>    
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">Bank entry metadata
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="mb-0 table table-sm">
                            ...
                            <tbody>
                                @php( $m = \App\Mpesa::where('internal_ref', $r['mpesa_ref'])->first() )
                                @if( is_null($m) )
                                    @php( $m = [] )
                                @else 
                                    @php( $m = $m->toArray())
